...
export function ListingFilterBar({
  ...
  return (
    <div className={`mb-5 grid min-w-0 grid-cols-1 gap-3 rounded-xl bg-foose-surface-low p-3 sm:grid-cols-2 lg:grid-cols-[minmax(0,1fr)_150px_150px_150px] [&_input]:min-h-11 [&_input]:min-w-0 [&_input]:max-w-full [&_input]:w-full [&_input]:rounded-lg [&_input]:border [&_input]:border-foose-border [&_input]:bg-white [&_input]:px-3 [&_input]:text-base [&_input]:outline-none [&_input]:focus:border-accent sm:[&_input]:text-sm [&_label]:grid [&_label]:min-w-0 [&_label]:gap-1 [&_label_span]:text-xs [&_label_span]:font-bold [&_label_span]:text-foose-muted ${className}`}>
      <label>
